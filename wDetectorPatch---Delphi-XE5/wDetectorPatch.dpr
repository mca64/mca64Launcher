...
begin
  ...
  try
    ZapiszTekstDoPamieci($3F949, #7'wD '#4'3.31 '#6' mca64Launcher');
    ZapiszTekstDoPamieci($3F274, #0); //aktywacja
    ...
    begin
      ...
      ZapiszTekstDoPamieci($41501, 'Okno dropowania wył.' + #$0A + #$08 + 'Nie wykonuj żadnych akcji,'
        + ' mogą one zostać uznane za ' + #04 + '"multi command"                          ');
    ...
    end else if jezyk = 1 then //angielski
    begin
