...
const
  ...
  angielski: TJezyk = (AV2: 'Time:'; AV3: 'Size:'; AV4: 'Dropped frames:'; AV5: 'Bitrate:'; AV6: 'Frames per second:'; AV7: 'Upload:';
    ...
    upnp: 'UPnP (port forwarding)'; bramki: 'Battle.net gateways'; wmode: 'StarCraft in window mode'; start: 'Start';
  ...
  francuski: TJezyk = ( // Myu
    ...
    pokazWeWy: 'Show joins/parts'; wyslij: 'Envoyer'; rozne: 'Divers'; nagrywanie: 'Enregistrement'; dotacje: 'Donate'; oProgramie: 'About';
    uVideo: 'Système vidéo:'; uAudio: 'Système audio:'; kodekVideo: 'Compression de vidéo:'; kodekAudio: 'Compression de l’audio:';
    podglad: 'Preview'; nagrywaj: 'Enregistrement'; tLogin: 'Identifiant:'; tHaslo: 'Mot de passe:'; domyslnyKanal: 'Canal par default:';
    zapiszCzat: 'Sauvegarde du chat'; autoPolaczenie: 'Connexion automatique au démarrage'; zapisz: 'Sauvegarde';
    maxBitrate: 'Débit binaire maximal:'; rodzajPrzeplywnosci: 'Méthode d''encodage:'; stala: 'Constant (DBC)'; zmienna: 'Variable (DBV)';
    przeplywnosc: 'Débit binaire:'; kanaly: 'Canaux:'; czestoliwosc: 'Fréquence d''échantillonnage:'; wartosc: 'Valeur:';
    predkosc: 'Changer la vitesse de la souris'; overlay: 'Afficher le calque design'; czasGry: 'Temps de jeu'; czas: 'Heure';
    trybObs: 'Mode observateur'; czatTwitcha: 'Accéder au chat Twitch'; apm: 'APM'; winamp: 'Winamp / AIMP';
