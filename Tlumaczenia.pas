...
const
  ...
  /// /////////////////////////////   ENGLISH
  angielski: TJezyk = (AV2: 'Time:'; AV3: 'Size:'; AV4: 'Dropped frames:'; AV5: 'Bitrate:'; AV6: 'Frames per second:'; AV7: 'Upload:';
    ...
    upnp: 'UPnP (port forwarding)'; bramki: 'Serverlist'; wmode: 'Window mode'; start: 'Start';
    ...
    konfiguruj: 'Configure'; liczbaWidzow: 'Viewers:'; pokazCzas: 'Show time'; pokazWeWy: 'Show join/leave notifications'; wyslij: 'Send';
    ...
    tHaslo: 'Password:'; domyslnyKanal: 'Default channel:'; zapiszCzat: 'Save chat'; autoPolaczenie: 'Automatically connect on startup';
    ...
    dataBuildu: 'Build time:'; wersja: 'Version:'; podziekowania: 'Special thanks for helping create this program go to:';
  ...
  hiszpanski: TJezyk = (AV2: 'Hora:'; AV3: 'Tamaño:'; AV4: 'Frames perdidos:'; AV5: 'Bitrate:'; AV6: 'Frames por segundo:'; AV7: 'Subir:';
    glosnosc: 'Control del volumen (CTRL + UP/DOWN)'; f1: 'Desactivar F1'; pause: 'PAUSA para pausar/continuar el juego';
    altshift: 'Desactivar ALT + SHIFT'; zagubione: 'Fix "lost" keyboard input'; zapora: 'Añadir excepción al firewall de Windows';
    znaki: 'Cambiar el set de caracteres'; skrin: 'Screenshot (CTRL + ALT + P)'; sprawdzLatency: 'Comprobar latencia';
    daneKonta: 'Ajustes de cuenta:'; ustawieniaCzatu: 'Ajustes del chat:'; ustawieniaStrumnieniowania: 'Streaming settings:';
    ustawieniaKonta: 'Ajustes de canal:'; ustawGre: 'Fijar juego: "StarCraft: Brood War"'; ustawOpis: 'Set description:';
    listaWidzow: 'Espectadores'; Pogrubienie: 'Negrita'; bnCzat: 'Chat de Battle.net ';
    sprawdzanieAktualizacji: 'Comprobar actualizaciones'; nagrywajLokalnie: 'Grabación local'; caps: 'Desactivar Bloq Mayús';
    jump: 'Winamp saltar a archivo'; wyswietl: 'Mostrar en el juego:'; funkcje: 'Functions:'; kbHook: 'Keyboard hook';
    listStrumieni: 'Actualizar lista de streams'; guiUniemozliwi: 'GUIfixes te previene unirte a servidores oficiales de Blizzard';
    listaGraczy: 'Lista de jugadores'; jKoreanski: 'Soporte para lenguaje koreano durante partida'; track: 'Song information';
    au1: 'OAuth debería ser generado aquí:'; au2: 'Debería parecerse a esto: '; au3: 'luego copiar y pegar todo el texto.';
    sekundy: 'sgundos'; dyskTwardy: 'Guardar en disco'; wysylanieWToku: 'Streaming en Twitch...';
    zakonczoneNiepo: 'Streaming en Twitch fallido'; wybierzAkcje: 'Elegir acción para el usuario '; uprawienia: 'Promocionar a moderador';
    tymczasowyBan: 'Ban temporalmente'; zbanuj: 'Ban permanentemente'; cofUpr: 'Degradar moderador'; listaOP: 'Lista de moderadores';
    odbanuj: 'Anular ban'; pobierzKlucz: 'Descargar clave de stream y guardar ajustes'; priorytet: 'Prioridad más alta para StarCraft';
    trwaPobieranieKlucza: 'Descargando clave de stream..'; opuscil: 'Partes:'; dolaczyl: 'Conexiones:'; polaczono: 'Conectado con';
    rozlaczono: 'Desconectado'; fishiInne: 'Fish y otros'; naprawKolory: 'Arreglo para perdida de colores ';
    emulacjaDD: 'DirectDraw emulación'; upnp: 'UPnP (abrir puertos)'; bramki: 'Puntos de acceso de Battle.net'; wmode: 'Modo ventana';
    start: 'Iniciar'; powiadomienie: 'Sonidos de notificación'; jezyk: 'Idioma:'; pokazLog: 'Mostrar log'; sprawdzTrase: 'Rastreador:';
    pokazKraj: 'Mostrar país'; hosty: 'Resolver nombre anfitrión'; pokazKlucz: 'Mostrar CD Key'; startCam: 'Inicar Cam:';
    stopCam: 'Parar Cam:'; lobby: 'Lobby:'; lobbyPrzed: 'Lobby de antes de partida:'; wGrze: 'Dentro de una partida:';
    odtwarzajDz: 'Reproducir sonido:'; kanal: 'Canal:'; polacz: 'Conectar'; polaczony: 'Conectado'; rozlacz: 'Desconectar';
    konfiguruj: 'Configurar'; liczbaWidzow: 'Espectadores:'; pokazCzas: 'Mostrar el tiempo'; pokazWeWy: 'Mostrar conexiones/partes';
    wyslij: 'Enviar'; rozne: 'Misc.'; nagrywanie: 'Grabación'; dotacje: 'Donar'; oProgramie: 'Acerca de'; uVideo: 'Dispositivo de video:';
    uAudio: 'Dispositivo de audio:'; kodekVideo: 'Compresión de video:'; kodekAudio: 'Compresión de audio:'; podglad: 'Previsualización';
    nagrywaj: 'Registro'; tLogin: 'Conectar:'; tHaslo: 'Password:'; domyslnyKanal: 'Canal predeterminado:'; zapiszCzat: 'Guardar chat';
    autoPolaczenie: 'Conectar autuomáticamente al iniciar'; zapisz: 'Guardar'; maxBitrate: 'Máximo bitrate:';
    rodzajPrzeplywnosci: 'Método de codifiación:'; stala: 'Constante (CBR)'; zmienna: 'Variable (VBR)'; przeplywnosc: 'Bitrate:';
    kanaly: 'Canales:'; czestoliwosc: 'Frecuencia de muestra:'; wartosc: 'Valor:'; predkosc: 'Velocidad del mouse'; overlay: 'Overlay';
    czasGry: 'Tiempo de la partida'; czas: 'Hora'; trybObs: 'Modo observador'; czatTwitcha: 'Twitch chat'; apm: 'APM';
    winamp: 'Winamp / AIMP'; autoreplay: 'Autoreplay'; ukryjPasek: 'Hide replay progress bar';
    ...
    wykorzystano: 'This program uses the following binary files from third parties:'; logowanie: 'Conectar automáticamente';
    dodaj: 'Añadir'; usun: 'Delete'; zapisujCzatBn: 'Save Battle.net chat'; czcionka: 'Cambiar fuente (Battle.net)';
    czcionkaDomyslna: 'Restablecer fuente'; otworzKatalog: 'Abrir la carpeta con las grabaciones'; aero: 'Windows Aero';
    trwaNagrywanie: 'Grabando:'; wiadomosci: 'Mensajes'; jednAt: 'Unidad generando daño:'; jednPrzy: 'Unidad recibiendo daño:';
    rasa: 'Raza:'; jednostka: 'Unidad:'; upAtak: 'Mejora de ataque:'; upArmory: 'Mejora de armadura:'; oblicz: 'Calculate';
    obrazenia: 'Daño:'; kalkulator: 'Calculadora'; aktywuj: 'Activar'; blokada: 'Desactivar la tecla de Windows';
    wsparciePolski: 'Soporte para lenguaje polaco durante la partida'; update: 'Nueva versión disponible';
    update2: 'Quiere abrir la página de descarga?'; schowek: 'Minimizar a la barra de inicio';
    dialog_uruchomiona: 'La aplicación ya está en marcha!'; lossless: '"Compresión de video sin perdidas"'; streamin: 'Stream en Twitch';
    opoznienie: 'Retraso:';);
  ...
  niemiecki: TJezyk = ( // freak,cryoc, enjoyme, iCCup.dAmn
    ...
    podglad: 'Vorschau'; nagrywaj: 'Record' { 'Aufzeichnung' }; tLogin: 'Login:'; tHaslo: 'Passwort:'; domyslnyKanal: 'Standard Kanal:';
  ...
  francuski: TJezyk = (AV2: 'Temps:'; AV3: 'Taille:'; AV4: 'Images perdues:'; AV5: 'Bitrate:'; AV6: 'FPS:'; AV7: 'Upload:';
    glosnosc: 'Contrôle du Volume (CTRL + HAUT/BAS)'; f1: 'Désactiver F1'; pause: 'Pause/reprise du jeu';
    altshift: 'Désactiver ALT + SHIFT'; zagubione: 'Fix "lost" keyboard input'; zapora: 'Ajouter exception dans le pare-feu Windows';
    znaki: 'Change the character set'; skrin: 'Capture d''écran (CTRL+ALT+P)'; sprawdzLatency: 'Contrôle de la latence';
    daneKonta: 'Paramètre du compte:'; ustawieniaCzatu: 'Paramètre du chat:'; ustawieniaStrumnieniowania: 'Paramètre de diffusion:';
    ustawieniaKonta: 'Paramètre du canal:'; ustawGre: 'Set game: "StarCraft: Brood War"'; ustawOpis: 'Sélectionner la description:';
    listaWidzow: 'Spectateurs'; Pogrubienie: 'Gras'; bnCzat: 'Discussion Battle.net';
    sprawdzanieAktualizacji: 'Vérification des mises à jour'; nagrywajLokalnie: 'Enregistrement local'; caps: 'Désactiver CAPS LOCK';
    jump: 'Winamp: Aller au fichier'; wyswietl: 'Affichage en jeu:'; funkcje: 'Fonctions:'; kbHook: 'Keyboard hook';
    listStrumieni: 'Mettre à jour la liste des diffusions';
    guiUniemozliwi: 'GUIfixes vous empêche de rejoindre les serveurs officiel Battle.net'; listaGraczy: 'Joueurs';
    jKoreanski: 'Assistance pour la langue coréenne en partie'; track: 'Infos sur la chanson'; au1: 'OAuth devrais être généré ici:';
    au2: 'Ceci devrait ressembler à cela: '; au3: 'next copy paste all text.'; sekundy: 'secondes';
    dyskTwardy: 'Enregistrer sur le disque dur'; wysylanieWToku: 'Diffuser sur Twitch...'; // l'utilisation
    zakonczoneNiepo: 'La diffusion sur Twitch a échouée'; wybierzAkcje: 'Choisir une fonction pour l''utilisation';
    uprawienia: 'Promouvoir comme modérateur'; tymczasowyBan: 'Bannir temporairement'; zbanuj: 'Ban permanent';
    cofUpr: 'Destituer un modérateur'; listaOP: 'Modérateurs'; odbanuj: 'Enlever le ban';
    ...
    rozlaczono: 'Déconnecter de'; fishiInne: 'Fish et autres'; naprawKolory: 'Correction des couleurs';
    emulacjaDD: 'Émulation ''DirectDraw'''; upnp: 'Activer l''UPnP'; bramki: 'Ajout de serveurs'; wmode: 'Lancer StarCraft en mode fenêtré';
    start: 'Démarrer'; powiadomienie: 'Notifications sonores'; jezyk: 'Langue:'; pokazLog: 'Voir le journal';
    ...
    lobby: 'Salon:'; lobbyPrzed: 'Salon de jeu:'; wGrze: 'En jeu:'; odtwarzajDz: 'Jouer les sons:'; kanal: 'Chaîne:'; polacz: 'Connecter';
    polaczony: 'Connecté'; rozlacz: 'Déconnecter'; konfiguruj: 'Configure'; liczbaWidzow: 'Nombre de spectateurs:';
    pokazCzas: 'Afficher l''heure'; pokazWeWy: 'Afficher les connexions/déconnexions'; wyslij: 'Envoyer'; rozne: 'Divers'; nagrywanie: 'Record';
    // 'Enregistrement';
    dotacje: 'Donate'; oProgramie: 'A propos'; uVideo: 'Système vidéo:'; uAudio: 'Système audio:'; kodekVideo: 'Compression de vidéo:';
    ...
    autoreplay: 'Replay automatique'; ukryjPasek: 'Cacher la barre de progression du replay'; // Cacher la barre de progression du replay
    usunLimit: 'Enlever la limite des slots lors du replay'; wyswietlZdjecie: 'Afficher l''image'; autor: 'Auteur:'; kontakt: 'Contact:';
    dataBuildu: 'Temps:'; wersja: 'Version:'; podziekowania: 'Special thanks for help in creation of this program go to:';
    wykorzystano: 'Ce programme utilise les fichier-tiers suivants:'; logowanie: 'Connection automatique'; dodaj: 'Ajouter'; usun: 'Supprimer';
    zapisujCzatBn: 'Save Battle.net chat'; czcionka: 'Changer la police (Battle.net)'; czcionkaDomyslna: 'Rétablir caca la police';
    otworzKatalog: 'Ouvrir le fichier de destination des enregistrements'; aero: 'Windows Aero'; trwaNagrywanie: 'Enregistrement:';
    wiadomosci: 'Messages'; jednAt: 'Dégâts des unitées:'; jednPrzy: 'Unitées recevant des dégâts:'; rasa: 'Race:'; jednostka: 'Unitée:';
    upAtak: 'Amélioration d''attaque:'; upArmory: 'Upgrade d''armure:'; oblicz: 'Calcul'; obrazenia: 'Dégâts:'; kalkulator: 'Calculateur';
    aktywuj: 'Activer'; blokada: 'Désactiver les touches Windows'; wsparciePolski: 'Assistance pour la langue Polonaise en jeu';
    update: 'Une nouvelle version est disponible'; update2: 'Voulez vous ouvrir la page de téléchargement ?'; schowek: 'Minimisez';
    dialog_uruchomiona: 'L''application est déjà activée!'; lossless: '"Compression vidéo sans perte"'; streamin: 'Diffusion sur Twitch';
    opoznienie: 'Délai:';);
  ...
  portugalski: TJezyk = ( // fabiano
    ...
    glosnosc: 'Controle de volume (CTRL + UP/DOWN)'; f1: 'Desabilitar F1'; pause: 'PAUSE para pausar/reiniciar o jogo';
    altshift: 'Desabilitar ALT + SHIFT'; zagubione: 'Corrigir input "perdido" do teclado';
    zapora: 'Adicionar exceção ao firewall do Windows'; znaki: 'Mudar o character set'; skrin: 'Screenshot (CTRL + ALT + P)';
    sprawdzLatency: 'Checar latência'; daneKonta: 'Configurações de conta:'; ustawieniaCzatu: 'Configurações de chat:';
    ustawieniaStrumnieniowania: 'Configurações de stream:'; ustawieniaKonta: 'Configurações de canal:';
    ustawGre: 'Definir jogo: "StarCraft: Brood War"'; ustawOpis: 'Definir descrição:'; listaWidzow: 'Expectadores'; Pogrubienie: 'Negrito';
    bnCzat: 'Battle.net chat'; sprawdzanieAktualizacji: 'Checar novas atualizações'; nagrywajLokalnie: 'Gravação local';
    caps: 'Desabilitar CAPS LOCK'; jump: 'Winamp jump to file'; wyswietl: 'Mostrar no jogo:'; funkcje: 'Funções:'; kbHook: 'Keyboard hook';
    listStrumieni: 'Atualizar lista de streams';
    guiUniemozliwi: 'Não é possível entrar nos servidores oficiais da Blizzard devido ao GUIFixes'; listaGraczy: 'Lista de jogadores';
    jKoreanski: 'Suporte ao Coreano no jogo'; track: 'Informações da música'; au1: 'OAuth deveria ser gerado aqui:';
    au2: 'Isto deveria parecer com isso: '; au3: 'a seguir copie e cole todo o texto.'; sekundy: 'segundos';
    ...
    pokazCzas: 'Mostrar tempo'; pokazWeWy: 'Mostrar entradas/partes'; wyslij: 'Enviar'; rozne: 'Misc.'; nagrywanie: 'Gravar';
    dotacje: 'Doar'; oProgramie: 'Sobre'; uVideo: 'Dispositivo de vídeo:'; uAudio: 'Dispositivo de áudio:';
    kodekVideo: 'Compressão de vídeo:'; kodekAudio: 'Compressão de áudio:'; podglad: 'Pré-visualizar'; nagrywaj: 'Gravar'; tLogin: 'Login:';
    tHaslo: 'Senha:'; domyslnyKanal: 'Canal padrão:'; zapiszCzat: 'Salvar chat';
    autoPolaczenie: 'Conectar-se automaticamente durante a inicialização'; zapisz: 'Salvar'; maxBitrate: 'Taxa de bits máxima:';
    rodzajPrzeplywnosci: 'Método de codificação:'; stala: 'Constante (CBR)'; zmienna: 'Variável (VBR)'; przeplywnosc: 'Taxa de bits:';
    kanaly: 'Canais:'; czestoliwosc: 'Taxa de amostra:'; wartosc: 'Valor:'; predkosc: 'Mudar sensibilidade do mouse';
    overlay: 'Mostrar overlay'; czasGry: 'Tempo do jogo'; czas: 'Horário'; trybObs: 'Modo observador'; czatTwitcha: 'Twitch chat';
    apm: 'APM'; winamp: 'Winamp / AIMP'; autoreplay: 'Autoreplay'; ukryjPasek: 'Hide replay progress bar';
    usunLimit: 'Remover limite de slots para replays'; wyswietlZdjecie: 'Mostrar foto'; autor: 'Autor:'; kontakt: 'Contato:';
    dataBuildu: 'Hora:'; wersja: 'Versão:'; podziekowania: 'Special thanks for help in creation of this program go to:';
  ...
  chorwacki: TJezyk = ( // Quirinus
    ...
    powiadomienie: 'Obavijesti zvukom'; jezyk: 'Jezik:'; pokazLog: 'Pokaži zapisnik'; sprawdzTrase: 'Traceroute:';
